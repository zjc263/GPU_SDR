...
def run(file_list, backend, attenuation, N_peaks, smoothing, a_cutoff, threshold, peak_width, Mag_depth_cutoff):
    for i in range(len(file_list)):
        ...
        if backend == 'matplotlib':
            ...
            single_plots = False
        u.plot_resonators(file_list[i], reso_freq = None, backend = 'plotly', title_info = None, verbose = False, output_filename = None, auto_open = True, attenuation = None,single_plots = False)
